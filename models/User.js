...
const UserSchema = new mongoose.Schema({
  ...
  password: {
    ...
    minlength: 6,
    select: false, //when we get a user through out API, it's not going to actually show the password, it's not gonna return the password if we're setting select ro false
  },
